...
- [ ] 2. 데이터베이스 계층 구현
  - [ ] 2.1 PostgreSQL 데이터베이스 클라이언트 구현
...
- [ ] 5. 서비스 계층 구현
  ...
  - [ ] 5.2 소설 서비스 속성 테스트 작성
    - **Property 1: 소설 생성 라운드 트립**
    - **검증 대상: 요구사항 1.1, 1.3**

  - [ ] 5.3 소설 목록 완전성 속성 테스트 작성
    - **Property 3: 소설 목록 완전성**
    - **검증 대상: 요구사항 2.1, 2.2**

  - [ ] 5.4 소설 상세 조회 시 챕터 포함 속성 테스트 작성
    - **Property 4: 소설 상세 조회 시 챕터 포함**
    - **검증 대상: 요구사항 3.1**

  - [ ] 5.5 소설 수정 적용 및 수정일 갱신 속성 테스트 작성
    - **Property 5: 소설 수정 적용 및 수정일 갱신**
    - **검증 대상: 요구사항 4.1, 4.2**

  - [ ] 5.6 소설 삭제 시 연쇄 삭제 속성 테스트 작성
  ...
  - [ ] 5.8 챕터 생성 라운드 트립 및 자동 순서 부여 속성 테스트 작성
    - **Property 7: 챕터 생성 라운드 트립 및 자동 순서 부여**
    - **검증 대상: 요구사항 6.1, 6.3, 7.1**

  - [ ] 5.9 챕터 수정 적용 및 수정일 갱신 속성 테스트 작성
    - **Property 8: 챕터 수정 적용 및 수정일 갱신**
    - **검증 대상: 요구사항 8.1, 8.2**

  - [ ] 5.10 챕터 삭제 후 순서 재정렬 속성 테스트 작성
    - **Property 9: 챕터 삭제 후 순서 재정렬**
    - **검증 대상: 요구사항 9.1, 9.2**

  - [ ] 5.11 챕터 순서 변경 순열 적용 속성 테스트 작성
    - **Property 10: 챕터 순서 변경 순열 적용**
    - **검증 대상: 요구사항 10.1**

  - [ ] 5.12 순서 변경 시 유효하지 않은 챕터 ID 거부 속성 테스트 작성
